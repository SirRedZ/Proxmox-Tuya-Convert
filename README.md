...
## CURRENT STATUS: Not Working - Do not proceed to pull this script (unless you want to work on it!)
...
```
bash -c "$(wget -qO - https://raw.githubusercontent.com/sirredz/proxmox-tuya-convert/development/create_container.sh)" -s local-lvm
```
